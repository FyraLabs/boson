...
if (platform === 'win32' && arch === 'x64') {
    ...
    nativeBinding = require(__dirname + '/steamworksjs.win32-x64-msvc.node')
} else if (platform === 'linux' && arch === 'x64') {
    // nativeBinding = require('./dist/linux64/steamworksjs.linux-x64-gnu.node')
    nativeBinding = require(__dirname + '/steamworksjs.linux-x64-gnu.node')
} else if (platform === 'darwin') {
    if (arch === 'x64') {
        // nativeBinding = require('./dist/osx/steamworksjs.darwin-x64.node')
        nativeBinding = require(__dirname + '/steamworksjs.darwin-x64.node')
    } else if (arch === 'arm64') {
        // nativeBinding = require('./dist/osx/steamworksjs.darwin-arm64.node')
        nativeBinding = require(__dirname + '/steamworksjs.darwin-arm64.node')
    }
} else {
